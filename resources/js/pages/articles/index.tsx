            ...
            <section className="bg-ink py-20 lg:py-28">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    {articles.data.length === 0 ? (
                        <p className="text-soft py-16 text-center text-sm">No articles published yet. Check back soon.</p>
                    ) : (
